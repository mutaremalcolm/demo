            ...
            <div className="fixed bg-white text-blue-800 px-10 py-1 z-10 w-full">
                <div className="flex items-center justify-between py-2 text-5xl">
                    <div className="font-bold text-blue-900 text-xl">
                        React <span className="text-blue-900">Application</span>
                    </div>
                    <div className="flex items-center text-gray-500">
                        ...
                        <div className="bg-center bg-cover bg-no-repeat rounded-full inline-block h-12 w-12 ml-2"
                ...
                <div className="w-10/12">
                    <div className="flex flex-row">
                        ...
                        <div className="bg-no-repeat bg-sky-600 border border-sky-900 rounded-xl w-5/12 ml-2 p-6"
                            ...
                            <a href="#" className="bg-sky-600 text-xl text-white underline hover:no-underline inline-block rounded-full mt-12 px-8 py-2"><strong>See messages</strong></a>
                        </div>
                    </div>
